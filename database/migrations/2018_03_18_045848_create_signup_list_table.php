...
/**
 * 클래스명:                       CreateSignupListTable
 * 클래스 설명:                    수강학생 목록 데이터 테이블을 만드는 마이그레이션
 * 만든이:                         3-WDJ 1401213 이승민
 * 만든날:                         2018년 3월 18일
 */
class CreateSignupListTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('signup_list', function (Blueprint $table) {
            /**
             *  01. 칼럼 정의
             *
            ...
            $table->foreign('std_id')->references('id')->on('student')->onUpdate('cascade')->onDleete('cascade');
    ...
    {
        Schema::dropIfExists('signup_list');
    }
}

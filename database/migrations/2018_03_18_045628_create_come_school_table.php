...
/**
 * 클래스명:                       CreateComeSchoolTable
 * 클래스 설명:                    등교 데이터 테이블을 만드는 마이그레이션
 * 만든이:                         3-WDJ 1401213 이승민
 * 만든날:                         2018년 3월 18일
 */
class CreateComeSchoolTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('come_school', function (Blueprint $table) {
            /**
             *  01. 칼럼 정의
    ...
    {
        Schema::dropIfExists('come_school');
    }
}
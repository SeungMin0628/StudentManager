...
/**
 * 클래스명:                       CreateCounselMessageTable
 * 클래스 설명:                    상담 요청 및 응답시 주고받은 메시지를 저장하는 테이블을 만드는 마이그레이션
 * 만든이:                         3-WDJ 1401213 이승민
 * 만든날:                         2018년 3월 18일
 */
class CreateCounselMessageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('counsel_message', function (Blueprint $table) {
            /**
             *  01. 칼럼 정의
             *
    ...
    {
        Schema::dropIfExists('counsel_message');
    }
}
